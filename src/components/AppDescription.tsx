...
const AppDescription = () => {
  return (
    <div className="my-10 p-5 lg:flex lg:justify-center ">
      <div className="rounded-md bg-white p-5 shadow-md lg:w-1/2">
        {/* <p className="text-sm">
        ...
        <p className="text-sm ">
          ...
          <b className="text-blue-600">(max ingredient number is 5)</b>
        </p>
        <p className="text-sm">
